...
@section('title','Slide')
@section('content')
<x-formheader url="{{ route('admin.slides.index') }}" name="Slide"></x-formheader>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
               ...
               <div class="d-flex m-t-2" style="justify-content: space-between;">
                <div class="d-flex col-md-5">
                    <a href="{{ route('admin.slides.create') }}" class="btn btn-inverse-success waves-effect waves-light col-md-4 m-r-2">Thêm Slide
                    </a>
                    ...
                    <select class="form-control-sm col-md-4" name="order" style="text-align-last: center;">
                        @php
                            $array = [
                                ...
                                "subject-desc" => "Tên Slide (z-a)",
                                "subject-asc" => "Tên Slide (a-z)",
                            ];
            ...
            <div class="card-block">
               <div class="row">
                  <div class="col-sm-12 table-responsive">
                        @include('admin.slide.page',['data' => $data,'query' => $query,'nameRoute' => $nameRoute])
                  </div>
               </div>
            </div>
         </div>
