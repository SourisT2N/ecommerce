...
@section('content')
<x-formheader url="{{ route('admin.users.index') }}" name="Người Dùng"></x-formheader>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
               ...
               <div class="d-flex m-t-2" style="justify-content: space-between;">
                <div class="d-flex col-md-5">
                    <a href="{{ route('admin.users.create') }}"class="btn btn-inverse-success waves-effect waves-light col-md-4 m-r-2" >Thêm Người Dùng
                    </a>
                    ...
                    <select class="form-control-sm col-md-4" name="order" style="text-align-last: center;">
                        @php
                            $array = [
                                ...
                                "name-desc" => "Tên Người Dùng (z-a)",
                                "name-asc" => "Tên Người Dùng (a-z)",
                                "email-desc" => 'Email Từ Trên Xuống',
                                "email-asc" => 'Email Từ Dưới Lên',
                            ];
            ...
            <div class="card-block">
               <div class="row">
                  <div class="col-sm-12 table-responsive">
                        @include('admin.user.page',['data' => $data,'query' => $query,'nameRoute' => $nameRoute])
                  </div>
               </div>
            </div>
         </div>
