...
@section('content')
<x-formheader url="{{ route('admin.status.index') }}" name="Trạng Thái Đơn Hàng"></x-formheader>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
               ...
               <div class="d-flex m-t-2" style="justify-content: space-between;">
                <div class="d-flex col-md-5">
                    <button type="button" class="btn btn-inverse-success waves-effect waves-light col-md-4 m-r-2" id="btnAdd" data-toggle="modal" data-target="#modalInput" >Thêm Trạng Thái
                    </button>
                    ...
                    <select class="form-control-sm col-md-4" name="order" style="text-align-last: center;">
                        @php
                            $array = [
                                ...
                                "name-desc" => "Tên Trạng Thái (z-a)",
                                "name-asc" => "Tên Trạng Thái (a-z)",
                            ];
            ...
            <div class="card-block">
               <div class="row">
                  <div class="col-sm-12 table-responsive">
                        @include('admin.orderstatus.page',['data' => $data,'query' => $query,'nameRoute' => $nameRoute])
                  </div>
               </div>
            </div>
         </div>
...
<x-formadd title="Trạng Thái" name="Tên Trạng Thái"></x-formadd>
@endsection
@section('footer')
